			...
			<div class="rightPans right-pans-micro-service" id="context">	
					...
					<div class="col-xs-12 col-sm-4  col-md-4 fnDets_2">
					 ...
					 <div class="col-sm-12 col-md-12 col-xs-12" style="height: 50px; background-color: #ffffff;margin-bottom: 20px; border-radius:5px; padding-left: 10px;">
						...
						<div class=" col-sm-2 col-md-2 col-xs-2 fa fa-copy copyClipboard clipboard-icon" style="text-align: center; padding: 14px; height: 50px; border-left: 1px solid #ddd;" ng-click="copytoclipboard('a')" ng-click-copy="{{details.apiendpoint}}" data-toggle="tooltip" title="Copy" id="titlemsgend"></i>
						</div>
					</div>
								</div>
						<br>
							...
							<div class="col-sm-12 col-md-12 col-xs-12" style="height: 50px; background-color: #ffffff; border-radius: 5px; padding-left: 10px;">
								...
								<div class="col-sm-2 col-md-2 col-xs-2 fa fa-copy fa copyClipboard clipboard-icon" style="text-align: center; padding:14px; height: 50px; border-left: 1px solid #ddd;" ng-click="copytoclipboard('b')" ng-click-copy="{{userAPIKeyText}}" data-toggle="tooltip" title="Copy" id="titlemsg"></div>
