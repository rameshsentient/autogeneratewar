...
.panel-red-btn:focus,.panel-red-btn{
	background-color: #a90000;
	border:1px solid #a90000;
	color: #ffffff;
}
...
.panel-green-btn:focus{
	border:1px solid  #6e7f28!important;
	background-color: #6e7f28!important;
	color: #ffffff;
}
.panel-green-btn:active{
	border:1px solid  #6e7f28!important;
	background-color: #6e7f28!important;
	color: #ffffff;
}
...
.panel-almond-btn:focus{
	background-color: #a28868!important;
	border:1px solid  #a28868!important;
	color: #ffffff;
}
.panel-almond-btn:active{
	background-color: #a28868!important;
	border:1px solid  #a28868!important;
	color: #ffffff;
}
...
.info-btn-almond:focus{
	color: #a28868!important;
    background-color: #fff !important;
    border:2px solid #a28868!important;
}
.info-btn-almond:active{
	color: #a28868!important;
    background-color: #fff !important;
   border: 2px solid #a28868 !important;
}
...
.info-btn-green:focus{
	background-color: #fff !important;
	border: 2px solid #abc445;
	color: #abc445;
}
.info-btn-green:active{
	background-color: #fff !important;
	border: 2px solid #abc445;
	color: #abc445;
}
...
.info-btn-green:hover{
	border:2px solid  #c4d683 !important;
	background-color: #e8efcc !important;
	color: #abc445 !important;
}
/* --------------------------------- */
.panel-desc{
	font-size: 16px;
				...
				<br/>
					...
					<div style="border-bottom-right-radius: 5px; border-bottom-left-radius: 5px; padding: 20px 15px 0px 15px;">
						<div>
							...
							<div ng-show="apiEndpointStatusData.length > 0" id="donutchart" class="chart-box" style="width: 100%; height: 60%; overflow:auto;"></div>
					...
					<div style="border-bottom-right-radius: 5px; border-bottom-left-radius: 5px; padding: 20px 15px 20px 15px;">					
							...
							<div ng-show="apiEndpointStatusData.length > 0" class="chart-box pad-15"  style="width: 100%; height: auto;">
