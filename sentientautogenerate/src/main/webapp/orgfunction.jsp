	...
	<div class="container-fluid container-fluid-BG pageTBMargin49">
		...
		<div class="padding0">
			...
			<div class="container-fluid marginMinus" ng-hide="fnDetails">
				...
				<div class="col-sm-6 popTable orgTable">
						...
						<tbody>
							<tr ng-repeat="fun in orgAssignFunctionList">
								...
								<td ng-if="orgDetails.orgType == 'child'">
									...
									<button ng-if="uAccess.ORG_REMOVEUSERFROMFUNCTION" style="margin:0px 0px 0px 11px;" class="uButton delePopId" data-toggle="modal" ng-click="removeFunFrmOrg(fun.id)"><i class="fa fa-close"></i></button>
								</td>
							</tr>
						</tbody>
					</table>
			...
			<div id="deleLang" class="modal fade popUpId" role="dialog">
			    ...
			    <!-- Modal content-->
			    	<div class="modal-content">
			    		...
			    		<p>Do you want to remove the function?</p>
