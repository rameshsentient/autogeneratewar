...
.tooltip-inner {
	...
	<body ng-app="sentiCatalog" ng-controller="solutionFunCtrl" ng-cloak>
						...
						<div class="microServBox">
								<div class="side-menu">
									<ul class="list-unstyled solution-menu" onclick="stopExpand(event)">
										<li ng-repeat="sname in solutionNames" ng-class="{'current-active':sname.id==solutionId}">
		...
		<div class="loading-container" ng-show="loadeer">
			...
			<div class="rightPans right-pans-micro-service" id="context">	
					<div class="fnNavTop " style="margin-top: 95px;">
					...
					<div class="row right-pans-row">
						...
						<div class="feature-card" ng-show="details.feature.length>0">
							<h4 style="padding-top: 10px;font-weight:bold"  ng-class="{true : 'marginHedding',false : ''}[details.funDesc2 == undefined || details.funDesc2 == '']"><%=lbl.get("FNDETAIL").get("FEATURE")%></h4>
							<div>
						...
						<div class="PricingPlan col-md-12 table-responsive padding0">
								...
								<table class="table table-condensed" style="border:1px solid #e2dede!important; margin-bottom:0px;">
									...
									<tbody  ng-repeat="pric in details.pricing" ng-click="selectMe($index)">
										<tr>
											...
											<td class="pricing-plan-table"><img style="width: 21px; margin-bottom: 1px;" src="resources/images/dollar-img.png"> <span aria-hidden="true">{{pric.price}}</td>
					...
					<div class="col-xs-12 col-sm-4  col-md-4 fnDets_2">
					    ...
					    <div class="col-xs-6">
					        <h4 style="font-weight: bold;">API </h4></div>
					    <div class="col-xs-6">
						...
						<div class="col-xs-12 feature-body"> 
							 ...
							 <div class="col-sm-12 col-md-12 col-xs-12" style="height: 50px; background-color: #ffffff;margin-bottom: 20px; border-radius:5px; padding-left: 10px;">
								<div class="col-sm-10 col-md-10 col-xs-10" style="line-height: 3.5; overflow-x: scroll; scrollbar-color: transparent; scrollbar-width: none; cursor: grab; white-space: nowrap;word-break: normal;"  ng-mouseover="showClipboardend()" >{{details.apiendpoint}}</div>
								<div class=" col-sm-2 col-md-2 col-xs-2 fa fa-copy copyClipboard clipboard-icon" style="text-align: center; padding: 14px 5px; height: 50px; border-left: 1px solid #ddd;" ng-click="copytoclipboard('a')" ng-click-copy="{{details.apiendpoint}}" data-toggle="tooltip" title="&nbsp; &nbsp;Copy&nbsp; &nbsp;" id="titlemsgend"></i>
								</div>
							</div>
										</div>
								<br>
									...
									<div class="col-sm-12 col-md-12 col-xs-12" style="height: 50px; background-color: #ffffff; border-radius: 5px; padding-left: 10px;">
										<div class="col-sm-10 col-md-10 col-xs-10" ng-if="userHaveAPIAccess" style="line-height: 3.5; overflow-x: scroll; scrollbar-color: transparent; scrollbar-width: none; cursor: grab; white-space: nowrap;word-break: normal;" ng-mouseover="showClipboard()">{{userAPIKeyText}}</div>
										<div class="col-sm-2 col-md-2 col-xs-2 fa fa-copy fa copyClipboard clipboard-icon" style="text-align: center; padding:14px 5px; height: 50px; border-left: 1px solid #ddd;" ng-click="copytoclipboard('b')" ng-click-copy="{{userAPIKeyText}}" data-toggle="tooltip" title="&nbsp; &nbsp;Copy&nbsp; &nbsp;" id="titlemsg"></div>
...
<div class="modal fade center-modal" id="contactsales">
    <div class="modal-dialog" role="document">
		...
		<script src="resources/js/jquery.js"></script>
	  	...
	  	<script src="resources/controller/solutionsFunctionDetailController.js"></script>
