	app.controller('solutionFunCtrl',function($scope,microFac,$localStorage, $http,$timeout){
	...
	$scope.solutionId=$localStorage.msData.sId;
	
	
//	Description2 Markdown start
...
//  Description2 Markdown end 	
	...
	$scope.functionDetails = function(id){
		...
		microFac.fnDetails(id).success(function(data){
			...
			$scope.details = data;
			$scope.details.funDesc2 = md.render($scope.details.funDesc2);
			console.log(data);
