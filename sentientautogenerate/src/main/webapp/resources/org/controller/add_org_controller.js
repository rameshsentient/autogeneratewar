app.controller('listOrganistn', function($localStorage,$window, $scope, $rootScope, $http, sentiOrg,$timeout) {
	...
	$scope.addOrg = function() {
		...
		if(($scope.newOrgName == undefined || $scope.newOrgName == "") ||($scope.newOrgUserName == undefined || $scope.newOrgUserName == "" || $scope.newOrgUserName.length<5) ||
