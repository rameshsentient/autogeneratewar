...
String RSA_ENCODE = APIUtil.RSA_ENCODE;
...
<head>
  ...
  <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.8.1/css/all.css"
	...
	<body ng-app="datafedApp" ng-controller="encodeController" style="font-family: avenir roman; font-size: 14px; color: #4f5671" >
		...
		<div class="container-fluid paddingLR30 pageTBMargin80 padding0"> 
		    <div class="col-md-12">
		        <div class="for-market-area"  style="margin-top:30px;">
		            <h4 class="btn_bg lable">Encrypt Text</h4>
		            <div class="box padding20" >
		            
			            <label>Encode text by using RSA Public Key</label> 
	
			            <div class="row">
						<div class="col-md-6">
					
	                	<div class="marginTop20"><label>Encode your Text </label></div>
	        			
						  <textarea ng-model = "inputtext" class="form-control animated" rows="10" name="publickeyparam" id="publickeyparam" > 
	       				  </textarea>
						</div>
						  <div class="col-md-6">
					
							
						  <div  class="marginTop20"><label>Public Key</label> </div>
				
						    <textarea ng-model="publickey" class="form-control animated" rows="10" name="privatekeyparam" id="privatekeyparam" >
					    ...
					    <div align="right"> 
					    <button type="button" ng-show ="isloading" class="btn btn-successcustom" ng-click="encodetext()" data-toggle="modal" data-target="#encode-text" >Encode Text </button>					   				 
					     <button type="button" ng-hide ="isloading" class="btn btn-successcustom">Encode Text <i class="fas fa-spinner fa-spin"></i></button>
						</div>
						
						  <div ng-if="encryptedkey.length>0"> <label>Encrypted Text</label> 
							<i class="fa fa-copy" id="txtpubkey1" ng-click="myCopy2()" class="btn btn-primary btn-xs" data-toggle="tooltip" title="copy"></i>							
								<div wraptext readonly> 
									<div style= "word-wrap: break-word"; readonly>
										<!-- <p ng-model="encryptedkey" id="encryptedtext"></p> -->
										<textarea class="form-control animated" rows="4" ng-model="encryptedkey" id="encrytedkeytext" style="background-color: #eee;" readonly>
	    									{{encryptedkey}}
	    								</textarea>
									</div> 
								</div>
...
<div class="modal fade" id="encode-text" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content" style="padding: 20px;">
		...
		<script src="resources/controller/encodeController.js"></script>
	</body>
		<script>
	$(function(){
