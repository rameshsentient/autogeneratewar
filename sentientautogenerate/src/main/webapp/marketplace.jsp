  ...
  <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.8.1/css/all.css"
	...
	<body ng-app="datafedApp" id="scrollCtrl" ng-controller="marketplaceController" ng-cloak style="background: #f6f6f6">
		...
		<div class=" container-fluid paddingLR30 padding0" style="margin-top: 130px;"> 
			  ...
			  <div ng-show="marketPlaceData.length == 0 && !showEndPagetext" style="padding: 10px; font-weight: bold; text-align: center;"><%=lbl.get("MARKETPLACE").get("NO_DATA")%></div>
			...
			<div class="modal-body">
				<div>
					...
					<p class="para-text">
								...
								<!-- <span ng-hide="hideUnwantedTxt">for <span class="dollar-sign">S</span> <span class="font-weight-bold"> {{currentBalance | number:0}}&nbsp;</span>and the credits have been locked. -->
								<span ng-hide="hideUnwantedTxt">for <span class="dollar-sign">S</span> <span class="font-weight-bold"> {{dsPrice | number:0}}&nbsp;</span>and the credits have been locked.
