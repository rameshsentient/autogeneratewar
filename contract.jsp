...
<head>
  ...
  <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.8.1/css/all.css"
	...
	<body ng-app="datafedApp" ng-controller="contractController" style="font-family: avenir roman;" ng-cloak>
...
<div class="container-fluid paddingLR30 padding0 Da-MS-top">
            <div class="col-md-12 padding0" style="padding-bottom:45px;">
          ...
          <table class="table table-hover box">
            <thead>
              <tr>
                ...
                <th scope="col"><%=lbl.get("CONTRACT_LIST").get("DATA_CONSUMER")%></th>
            ...
            <tbody>
              <tr ng-repeat="contract in contractData"  ng-click="goToDetailPage(contract)" style="cursor: pointer;"  title="{{contract.Record.titlemsg}}">  
                ...
                <td>{{(contract.Record.finalprice).toFixed(2) | currency:value=""}}</td>         
...
<!--           <div style="text-align: center; font-weight: bold; padding-top:20px" ng-show=""></div>      --> --%>    
        </div>
        </div>
		...
		<script src="resources/controller/contractController.js"></script>
	</body>
<script>
	$(function(){
	...
	$(window).scroll(function (e){
	    ...
	    if (body.scrollHeight - scrollTop === parseFloat(body.clientHeight)) {
	        angular.element(document.querySelector('[ng-controller="contractController"]')).scope().scrollingIsActiveRightNow()
	    }
	});

	$("#sellcont").addClass("active");
</script>
