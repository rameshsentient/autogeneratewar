			...
			<div class="row">
			 	<div class="form-group col-sm-6 col-md-6">
	              ...
	              <div class="input-group-btn border-button">
	                <input type="text" ng-model="daSetting.commissionValue" id="commisionPer" class="form-control" onkeyup="return checkCommision()" placeholder="Enter Min. Commission Value" style="cursor:pointer;"/>
	              </div>
	            </div>
	            ...
	            <div class="form-group col-sm-6 col-md-6">
	              ...
	              <div class="input-group-btn border-button">
	                <input type="text" ng-model="daSetting.commissionPercentage" id="commisionPer" class="form-control" onkeyup="return checkCommision()" placeholder="15.00" style="cursor:pointer;"/>
	              </div>
	            </div>
	        </div>
...
<script>
	...
	function checkCommision(){
        var input = document.getElementById('commisionPer');
	...
	function checkCommision(){
        var input = document.getElementById('feesPaid');
        var ponto = input.value.split('.').length;
        if (ponto > 2)
                input.value=input.value.substr(0,(input.value.length)-1);
