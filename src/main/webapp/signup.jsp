			...
			<div id="tcpopup" class="modal fade popUpId" role="dialog">
			    ...
			    <!-- Modal content-->
			    	<div class="modal-content"  style="margin-top: 60px;margin-left:20px;margin-right:20px; margin-botton:60px;height:45%;">
			    		...
			    		<div class="col-md-6 col-sm-6 col-xs-12 text-right"><button  type="submit" class="btn subBtn" data-dismiss="modal" style="background-color: #bc0000 !important;margin-top: 10px ">Decline</button></div>
						<div class="col-md-6 col-sm-6 col-xs-12 text-left"><button  type="submit" ng-click="submitform()" class="btn subBtn" style="background-color: #a4c158 !important; margin-top: 10px; overflow-x: hidden; width: fit-content; word-break: break-word;">I agree with Terms & Conditions</button></div>
					</div>
					</div>
				</div>
			</div>		
			...
			<div id="alertmodel" class="modal fade popUpId" role="dialog">
			    ...
			    <!-- Modal content-->
			    	<div class="modal-content">
			    		...
			    		<p> 
							We have received your registration information.<br/> 
							Our Client Service Team  will contact you shortly.</p>
