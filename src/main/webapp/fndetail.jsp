		...
		<div class="loading-container" ng-show="loadeer">
			...
			<div class="rightPans right-pans-micro-service" id="context">	
					...
					<div class="row right-pans-row">
						...
						<div class="PricingPlan col-md-12 table-responsive padding0" ng-show="details.pricing.length>0">
						<h4 style="font-weight:bold"><%=lbl.get("FNDETAIL").get("PRICE_PLAN")%></h4>
						...
						<div class="PricingPlan col-md-12 table-responsive padding0" ng-show="details.dataschema.length>0">
						<h4 style="font-weight:bold">Data schema</h4>
