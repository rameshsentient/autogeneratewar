			...
			<div class="padding20 box">
				<div  class="row rowLR">
					...
					<div class="col-md-2 paddingLeft0" style="padding-right: 0px;" ng-show="isSuperAdmin">
						<div style="text-align: center; padding-top: 8px !important; font-size: 14px; font-weight: bold;">
						 <select class="form-control" ng-model="credit_Type"  ng-init="duration='current'" ng-change="" style="cursor:pointer">
							<option value="" selected><%=lbl.get("CREDITEXPIRY").get("SELECT_TYPE")%></option>
							<option value="ADD_CRE_MARK_CRED" ><%=lbl.get("CREDITEXPIRY").get("MARKETING_CREDIT")%></option>
							<option value="ADD_CRE_CRED_TOP" ><%=lbl.get("CREDITEXPIRY").get("CREDIT_TOP_UP")%></option>
						</select>
						</div>
					</div>
				...
				<div class="row rowLR table-responsive border-box-table table-bottom">
					<table class="table table-hover table-striped ">
						...
						<tr ng->
							...
							<th><%=lbl.get("CREDITEXPIRY").get("TAB_PRIORITY")%></th>
						...
						<tbody ng-show="!isActive" >
							<tr ng-repeat="expRecs in expiryRecords" style="cursor:pointer;">
