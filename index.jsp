                            ...
                            <div class="dashPage" ng-cloak>
                                ...
                                <div class="container-fluid paddingLR30 pageTBMargin padding0 box ">
                                    ...
                                    <section class="tablData col-md-12 padding10"  style="display: inline-block;">
                                        <button class="btn btn-successcustom  marginTop20" id="creatKbase" ng-click="clearFiles()"> <%=labelMap.get("DOC_LST").get("D_LST_ADDDOC")%></button>
                                    <span style="padding-left: 10px;"></span>
                                        <button class="btn btn-successcustom  marginTop20" ng-click="clearFiles()">Document search</button>
                                        <div class="clearfix"></div>
...
<table class="table-striped table-hover box" id="documentTable" style="margin-top: 22px;" datatable="ng" dt-options="showCase.dtOptions" dt-column-defs="showCase.dtColumnDefs">
 <thead>
                                                ...
                                                <tbody>
                                                    <tr ng-repeat="val in tableDatz | filter : filterTable" ng-style="val.check_bx === true ? { 'background-color':'#e8e8e8'} : { 'background-color':''}">
                                                        <!-- <td>
                                                                <div class="checkbox">
...
-->       
                                                 <td ng-click="editDoclist(val.docId)">{{val.docAccess}}</td>
                                                        ...
                                                        <td ng-click="editDoclist(val.docId)">{{customDateFormat(val.dateUpdated)}}</td>
