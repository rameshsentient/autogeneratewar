...
<div class="col-sm-12">
					...
					<div class="marginTop10 marginRight10 textRight"style="padding-bottom: 45px;">	
						...
						<button class="btn btn-default marginLeft5" data-toggle="modal" data-target="#confimationPop"><%=labelMap.get("EDIT_DOC").get("D_EDT_DELETE")%></button>
						<button class="btn btn-successcustom marginLeft5" ng-click="updateData(editList)"><%=labelMap.get("EDIT_DOC").get("D_EDT_UPDATE")%></button>
						<div class="clearfix"></div>
					</div>	
				</section>
			</div>
