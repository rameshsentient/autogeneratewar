...
@media screen and (min-device-width: 768px) and (max-device-width: 926px) { 
    ...
    <h4 class="schema-add" id="focusBtnCreateBtn"> <button class="btn_bg1" ng-click="clickShow()" ng-hide="toggleOff" data-toggle="modal" data-target="#createdata" > <%=lbl.get("DATASCHEMA").get("CREATE_SCHEMA")%></button>
            ...
            <tbody>
              ...
              <tr ng-repeat="res in dataSchemaItems" title="view more">
                <td ng-click="viewMore(res)"  style="cursor:pointer;" class="fixed-width" ><button ng-class="getStatusClass(res.Record.status)" style="text-transform: capitalize;">{{res.Record.status}}</button></td>
              	<td class="table-description" ng-click="viewMore(res)" data-container="body" data-toggle="tooltip" title="{{res.Record.name}}"><span class="span-description">{{res.Record.name}}</span></td>             
                <td ng-click="viewMore(res)"  style="cursor:pointer;">{{res.Record.displayprice | number:0}}</td>
              	<td ng-click="viewMore(res)"  style="cursor:pointer;">{{res.Record.category}}</td>
						...
						<td>
								<span class="action-icons" ng-click="showCloneData(res.Record)" data-toggle="modal" data-target="#createdata"> <i class="fa fa-clone" title="clone">&nbsp;</i>Clone</span>
								   <span class="action-icons" ng-show="showTrash" ng-click="deletebox(res.Record.id)" title="delete"> <i class="fa fa-trash aligncenter" aria-hidden="true" >&nbsp;</i>Delete</span>
							 </td>
              </tr>
		...
		<div class="modal-dialog">
			<div class="modal-content">
	            ...
	            <div class="modal-footer" style="text-align:center;">
	                ...
	                <button type="button" class="btn " ng-hide="deleteBtn" style="background:rgb(102, 117, 122);"><%=lbl.get("DATASCHEMA").get("WAIT")%> <i class="fas fa-spinner fa-spin"></i></button>
		...
		<div class="modal-dialog" role="document">
		  <div class="modal-content">
		    <div class="modal-header thanksModal">
		      <br>
		      <i class="far fa-check-circle outline-tick" style="font-size: 45px;  color: #3ed040;"></i>
	...
	<div class="modal fade center-modal" id="openDataSetModal" tabindex="-1" role="dialog" aria-hidden="true" style="z-index:1090!important;top: 20%;">
		<div class="modal-dialog" role="document">
		  <div class="modal-content">
			...
			<div class="modal-footer" style="text-align:center;">
		  	  <button type="button" class="btn btn_save btn-successcustom" ng-click="setOpenDataSetValue('')" style="margin-right: 30px;">Proceed</button>
					...
					<div class="modal-dialog modal-lg">
							<div class="modal-content">
									<div class="modal-header padding0">
									  ...
									  <h3 class="font-weight-bold" style="text-align: left; padding-left:40px;">Create Dataset</h3>
									</div>
							 ...
							 <label class="font-weight-bold" for="Price"><%=lbl.get("DATASCHEMA").get("PERIOD")%><sup><i class="fas fa-info-circle"  title="<%=lbl.get("DATASCHEMA").get("PERIOD_TOOLTIP")%>"></i></sup></label>
							   <div class="row">
								<div class="col-sm-12 col-md-12">
								  <div class="row">
									<div class="col-sm-1 col-md-1 ">
									  <label style="font-size:1rem;" ><%=lbl.get("DATASCHEMA").get("FROM")%></label>
									</div>
								  
									<div class="col-sm-3 col-md-3 col-xs-3 paddingRight">
									...
									<div class="col-sm-3 col-md-3 col-xs-3 paddingRight paddingLeft5">
									...
									<div class="col-sm-3 col-md-3 col-xs-3 paddingLeft5">
								...
								<!-- <div class="col-sm-6 col-md-6"> -->
								  <div class="row">
									<div class="col-sm-1 col-md-1 ">
									  <label style="font-size:1rem;"><%=lbl.get("DATASCHEMA").get("TO")%></label>
									</div>
									<div class="col-sm-3 col-md-3 col-xs-3 paddingRight">
							  ...
							  <div class="form-group col-sm-6 col-md-6">
									...
									<input type="radio" name="fileType" value="document" ng-model="dataSchema.samplefiletype" ng-change="chooseFileType()" style="padding: 10px; cursor: pointer;"><span style="font-weight: normal;"> <%=lbl.get("DATASCHEMA").get("UPLOAD_FILE")%></span>
									<input type="radio" name="fileType" value="url" ng-model="dataSchema.samplefiletype" ng-change="chooseFileType()" style="padding: 10px; cursor: pointer;"><span style="font-weight: normal;"> <%=lbl.get("DATASCHEMA").get("SAMPLE_URL")%></span>
								  </div>
								  <div class="form-group col-sm-6 col-md-6">
										 <div ng-hide="uploadFile" class="file-upload">
