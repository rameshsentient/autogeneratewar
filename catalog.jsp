    ...
    <section class="wrapper">
        ...
        <div class="container-fluid padding-none" ng-show="showTitle">
            ...
            <div class="rightPans">
                <div class="well solution-pan">
				    <div class="row">
				        <div class="col-md-8">
				            <div class="font-weight-bold marginBottom20" style="font-weight: bold; font-size: 25px; color: #3b3b3b;"><%=catalogLbl.get("CATALOG").get("SLU_TITLE")%></div>
		...
		<!-- MICROSERVICE VIEW START -->
               <div class="well micro-service-pan">
				    <div class="row">
				        <div class="col-md-8">
				            <div class="font-weight-bold marginBottom20" style="font-weight: bold; font-size: 25px;color: #3b3b3b;">
